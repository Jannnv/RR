...
def load_data():
    ...
    gdf = gpd.read_file('Peta/idn_admbnda_adm2_bps_20200401.shp')
    ...
    # Filter for NTB, NTT and exclude Malaka
    gdf = gdf[gdf['ADM1_EN'].isin(['Nusa Tenggara Barat', 'Nusa Tenggara Timur'])]
    gdf = gdf[gdf['ADM2_EN'] != 'Malaka']
    gdf['kab_key'] = gdf['ADM2_EN'].apply(clean_name)
...
if selected_prov != 'Seluruhnya':
    ...
    temp_gdf = gpd.read_file('Peta/idn_admbnda_adm2_bps_20200401.shp')
